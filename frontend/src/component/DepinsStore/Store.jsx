  ...
  return (
    <div className="min-h-screen bg-[#0D1B2A] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <div className="inline-block relative">
            ...
            <h1 className="relative text-6xl md:text-8xl font-bold text-white mb-6 tracking-tight">
              DePIN Hardware
              <span className="text-[#20C997]">Store</span>
            </h1>
          </div>
      ...
      <div className="relative">
        <div className="flex gap-4 px-4 py-8 mb-8 max-w-7xl mx-auto overflow-x-auto hide-scrollbar">
          <button
            onClick={() => setSelectedCategory("All")}
            className={`px-6 py-3 rounded-xl relative overflow-hidden group transition-all duration-300 min-w-max ${
              selectedCategory === "All"
