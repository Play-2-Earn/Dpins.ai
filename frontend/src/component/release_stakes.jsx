    ...
    const fetchActiveTasks = async () => {
      try {
        ...
        const response = await fetch(
          "http://localhost:5000/questions/active?include_answers=true",
          {
            method: "GET",
            headers: {
        ...
        <div className=" flex flex-wrap flex-col justify-center">
          {spinner ? (
            <Spin
              indicator={
                <LoadingOutlined
                  style={{ fontSize: "48px", color: "#34D399" }}
                  spin
                />
              }
              size="large"
            ...
            <table className="border-separate border-spacing-y-4 w-full">
              ...
              <tbody>
                {activeStakes.length > 0 && currentTasks.length > 0 ? (
                  currentTasks.map(
                    (
                      {
                        stake,
                      ...
                      <tr
                        className="text-center h-[50px] hover:bg-slate-600"
                      ...
                      >
                        ...
                        <td>
                          <button
                            ...
                            className="w-[140px] rounded-3xl bg-emerald-400 py-1 px-2 text-sm shadow-lg shadow-emerald-800 hover:bg-emerald-300 hover:text-grey hover:shadow-sm hover:shadow-emerald-500 transition-shadow transition-2 ease-in-out"
                          >
                            Release Stake
                          </button>
                        </td>
